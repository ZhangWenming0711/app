    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          ...
          <!-- 小图列表 -->
          <ImageList :skuImageList="skuImageList" :spuSaleAttrList="spuSaleAttrList" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(saleAttr, index) in spuSaleAttrList" :key="saleAttr.id">
                ...
                <dd changepirce="0" v-for="(
                    spuSaleAttrValue, index
                  ) in saleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id"
                  :class="{ active: spuSaleAttrValue.isChecked == 1 }" @click="
                    changeActive(
                      spuSaleAttrValue,
...
export default {
  ...
  methods: {
    changeActive(value_Obj, arr) {
      arr.forEach((element) => {
        element.isChecked = 0;
      });
      value_Obj.isChecked = 1;
    },
    changeSkuNum(event) {
