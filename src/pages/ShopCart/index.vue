      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(good,index) in cartInfoList" :key="good.id">
          <li class="cart-list-con1">
            <input type="checkbox" name="chk_list" :checked="good.isChecked==1" @change="updateChecked(good,$event)">
          </li>
          ...
          <li class="cart-list-con7">
            <a class="sindelet" @click="deleteCartListBySkuId(good.skuId)">删除</a>
            <br>
            <a href="#none">移到收藏</a>
          </li>
        </ul>
...
export default {
  ...
  methods: {
    ...
    async deleteCartListBySkuId(id) {
      try {
